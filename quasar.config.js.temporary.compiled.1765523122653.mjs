...
var __quasar_inject_import_meta_url__ = "file:///Users/mokwen/dev/gitrepos/bluegithub/autocheck/quasar.config.js";
var quasar_config_default = defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      // vueDevtools,
      vueOptionsAPI: false,
      // Disable Options API per constitution
    ...
    framework: {
      ...
      // Quasar icon set per constitution
      lang: "en-US",
    ...
    electron: {
      ...
      builder: {
        ...
        copyright: "Copyright \xA9 2025 AutoCheck",
