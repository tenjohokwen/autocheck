...
### 2.1 Create Root "app" Folder

1. Go to [Google Drive](https://drive.google.com)
2. Navigate to the location where you want to store files
3. Create a new folder named `app`
...
| --------------------- | ------------------------- | ----------------------------- |
| `AUTH_SPREADSHEET_ID` | `{your-spreadsheet-id}`   | ID from Step 1.1              |
| `CLIENT`              | `client name`             | name of client.               |
| `ENV`                 | `app env`                 | env of app (test/prod)        |
| `APP_NAME`            | `app name`                | name of app                   |
